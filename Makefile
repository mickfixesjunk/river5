...
LIB_SRC  = csrc/river5.c csrc/river5_stub.c csrc/river5_aesni.c \
           ...
           csrc/river5_aesni_v6.c csrc/river5_aesni_v15.c csrc/river5_aesni_v15p.c \
...
$(BUILD)/libriver5.a: $(LIB_SRC) include/river5.h csrc/river5_internal.h | $(BUILD)
	...
	$(CC) $(CFLAGS) $(CPPFLAGS) $(INCLUDES) -c csrc/river5_aesni_v15.c -o $(BUILD)/river5_aesni_v15.o
	$(CC) $(CFLAGS) $(CPPFLAGS) $(INCLUDES) -c csrc/river5_aesni_v15p.c -o $(BUILD)/river5_aesni_v15p.o
	$(CC) $(CFLAGS) $(CPPFLAGS) $(INCLUDES) -c third_party/xxhash/xxhash.c -o $(BUILD)/xxhash.o
	ar rcs $@ $(BUILD)/river5.o $(BUILD)/river5_stub.o $(BUILD)/river5_aesni.o $(BUILD)/river5_aesni_v2.o $(BUILD)/river5_aesni_v3.o $(BUILD)/river5_aesni_v6.o $(BUILD)/river5_aesni_v15.o $(BUILD)/river5_aesni_v15p.o $(BUILD)/xxhash.o
