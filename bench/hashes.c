...
/* ---------- river5 v10 (direct vtable, heavy fix: double butterfly in main loop) ---------- */

static void river5_v10_one(const void *in, size_t len, uint8_t *out)
{
    RIVER5_VTABLE_AESNI_V10.one_shot(in, len, NULL, out);
}
static void *river5_v10_new(void)
{
    return RIVER5_VTABLE_AESNI_V10.new_state(NULL);
}
static void  river5_v10_update(void *s, const void *d, size_t n)
{
    RIVER5_VTABLE_AESNI_V10.update((river5_ctx_t *)s, d, n);
}
static void  river5_v10_digest(void *s, uint8_t *out)
{
    RIVER5_VTABLE_AESNI_V10.finalize((river5_ctx_t *)s, out);
}
static void  river5_v10_free(void *s)
{
    RIVER5_VTABLE_AESNI_V10.free_state((river5_ctx_t *)s);
}

static const hash_impl river5_v10_impl = {
    .name        = "river5-v10",
    .output_bits = 128,
    .one_shot    = river5_v10_one,
    .new_state   = river5_v10_new,
    .update      = river5_v10_update,
    .digest      = river5_v10_digest,
    .free_state  = river5_v10_free,
};
