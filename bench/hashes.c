...
/* ---------- river5 v13 (direct vtable, content-dependent shuffles) ---------- */

static void river5_v13_one(const void *in, size_t len, uint8_t *out)
{
    RIVER5_VTABLE_AESNI_V13.one_shot(in, len, NULL, out);
}
static void *river5_v13_new(void)
{
    return RIVER5_VTABLE_AESNI_V13.new_state(NULL);
}
static void  river5_v13_update(void *s, const void *d, size_t n)
{
    RIVER5_VTABLE_AESNI_V13.update((river5_ctx_t *)s, d, n);
}
static void  river5_v13_digest(void *s, uint8_t *out)
{
    RIVER5_VTABLE_AESNI_V13.finalize((river5_ctx_t *)s, out);
}
static void  river5_v13_free(void *s)
{
    RIVER5_VTABLE_AESNI_V13.free_state((river5_ctx_t *)s);
}

static const hash_impl river5_v13_impl = {
    .name        = "river5-v13",
    .output_bits = 128,
    .one_shot    = river5_v13_one,
    .new_state   = river5_v13_new,
    .update      = river5_v13_update,
    .digest      = river5_v13_digest,
    .free_state  = river5_v13_free,
};
