...
/* ---------- river5 v11 (direct vtable, PCLMULQDQ experimental) ---------- */

static void river5_v11_one(const void *in, size_t len, uint8_t *out)
{
    RIVER5_VTABLE_AESNI_V11.one_shot(in, len, NULL, out);
}
static void *river5_v11_new(void)
{
    return RIVER5_VTABLE_AESNI_V11.new_state(NULL);
}
static void  river5_v11_update(void *s, const void *d, size_t n)
{
    RIVER5_VTABLE_AESNI_V11.update((river5_ctx_t *)s, d, n);
}
static void  river5_v11_digest(void *s, uint8_t *out)
{
    RIVER5_VTABLE_AESNI_V11.finalize((river5_ctx_t *)s, out);
}
static void  river5_v11_free(void *s)
{
    RIVER5_VTABLE_AESNI_V11.free_state((river5_ctx_t *)s);
}

static const hash_impl river5_v11_impl = {
    .name        = "river5-v11",
    .output_bits = 128,
    .one_shot    = river5_v11_one,
    .new_state   = river5_v11_new,
    .update      = river5_v11_update,
    .digest      = river5_v11_digest,
    .free_state  = river5_v11_free,
};
